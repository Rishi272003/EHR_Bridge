...
from services.ehr.practice_fusion.categories.Organization import Organization
...
class OrganizationQueryTransformer(Transformer):
    ...
    def transform(self):
        """
        Transform organization query request and fetch data from Practice Fusion.
        """
        try:
            ...
            # Fetch organization data from Practice Fusion
    ...
    def _get_identifier_type(self, identifier):
        ...
        if "us-npi" in system or "npi" in system.lower():
            return "NPI"
        elif "2.16.840.1.113883.4.391" in system or "urn:oid:2.16.840.1.113883.19.5" in system:
            return "OID"
        elif "practicefusion" in system.lower():
            return "PracticeFusionID"
